...
# Set environment
ENV_DIR="${ENV_DIR:-<%= getenv!(:config_directory) %>/env.d}"
ENV_TARGET_DIR="${ENV_TARGET_DIR:-<%= getenv!(:config_directory) %>/env}"
...
rm -f $temp_file
ln -fs "${ENV_TARGET_DIR}/profile.sh" "${PROFILE_DIR}/parasite-env.sh"
